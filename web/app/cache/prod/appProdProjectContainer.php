...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'tpbd', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_diextra/doctrine/EntityManager.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_bd646256bdeeec6351d1ae4f67e645d0');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_bd646256bdeeec6351d1ae4f67e645d0');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_bd646256bdeeec6351d1ae4f67e645d0');
        ...
        $d->setProxyDir('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM50ad422f98510_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/gonzalo/www/estudioTSP/SymfonyBD/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/gonzalo/www/estudioTSP/SymfonyBD/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod',
            ...
            'session.save_path' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM50ad422f98510_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/home/gonzalo/www/estudioTSP/SymfonyBD/app/cache/prod/jms_security',
