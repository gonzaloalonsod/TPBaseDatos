...
use Tp\StamparBundle\Entity\LineaFactura;
use Tp\StamparBundle\Form\LineaFacturaType;
use Tp\StamparBundle\Form\LineaFacturaFilterType;
...
class LineaFacturaController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:LineaFactura')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TpStamparBundle:LineaFactura')->find($id);
     ...
     * @Method("post")
     * @Template("TpStamparBundle:LineaFactura:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("TpStamparBundle:LineaFactura:edit.html.twig")
     */
