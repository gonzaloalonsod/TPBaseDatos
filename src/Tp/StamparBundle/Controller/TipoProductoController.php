...
use Tp\StamparBundle\Entity\TipoProducto;
use Tp\StamparBundle\Form\TipoProductoType;
use Tp\StamparBundle\Form\TipoProductoFilterType;
...
class TipoProductoController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:TipoProducto')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TpStamparBundle:TipoProducto')->find($id);
     ...
     * @Method("post")
     * @Template("TpStamparBundle:TipoProducto:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("TpStamparBundle:TipoProducto:edit.html.twig")
     */
