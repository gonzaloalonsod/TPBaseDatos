...
use Tp\StamparBundle\Form\RubroFilterType;
...
class RubroController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:Rubro')->createQueryBuilder('e');
    ...
    */
    ...
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('rubro_show', array('id' => $entity->getId())));        } else {
