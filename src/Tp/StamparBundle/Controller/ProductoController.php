...
use Tp\StamparBundle\Entity\Producto;
use Tp\StamparBundle\Form\ProductoType;
use Tp\StamparBundle\Form\ProductoFilterType;
...
class ProductoController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:Producto')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TpStamparBundle:Producto')->find($id);
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Producto:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Producto:edit.html.twig")
     */
