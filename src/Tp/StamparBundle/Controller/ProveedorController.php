...
use Tp\StamparBundle\Entity\Proveedor;
use Tp\StamparBundle\Form\ProveedorType;
use Tp\StamparBundle\Form\ProveedorFilterType;
...
class ProveedorController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:Proveedor')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TpStamparBundle:Proveedor')->find($id);
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Proveedor:new.html.twig")
     */
    public function createAction()
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('proveedor_show', array('id' => $entity->getId())));        } else {
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Proveedor:edit.html.twig")
     */
