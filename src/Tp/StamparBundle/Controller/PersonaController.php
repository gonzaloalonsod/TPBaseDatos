...
use Tp\StamparBundle\Entity\Persona;
use Tp\StamparBundle\Form\PersonaType;
use Tp\StamparBundle\Form\PersonaFilterType;
...
class PersonaController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('TpStamparBundle:Persona')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TpStamparBundle:Persona')->find($id);
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Persona:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("TpStamparBundle:Persona:edit.html.twig")
     */
